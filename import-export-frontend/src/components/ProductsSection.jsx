  ...
  const products = [
    {
      ...
      fullDescription: 'Our Moringa Powder is sourced from the finest moringa trees and processed under strict quality controls. Rich in vitamins, minerals, and antioxidants, this superfood powder meets international food safety standards. Perfect for health supplements, beverages, and functional foods.',
      ...
      applications: ['Health Supplements', 'Functional Beverages', 'Nutritional Foods', 'Cosmetics'],
    ...
    },
    {
      ...
      fullDescription: 'Premium dehydrated tomato powder made from carefully selected ripe tomatoes. Our processing method preserves natural color, flavor, and nutritional value. Ideal for soups, sauces, seasonings, and instant food products.',
      ...
      applications: ['Soups & Sauces', 'Instant Foods', 'Seasonings', 'Food Processing'],
    ...
    },
    {
      ...
      fullDescription: 'Premium Spinach Powder processed from fresh green spinach leaves. Retains maximum nutritional value including iron, calcium, and vitamins. Excellent for health supplements, baby food, and fortified products.',
      ...
      applications: ['Baby Food', 'Health Supplements', 'Green Smoothies', 'Fortified Foods'],
    ...
    },
    {
      ...
      fullDescription: 'High-quality Ginger Powder made from premium ginger roots. Our careful drying and grinding process ensures maximum retention of essential oils and active compounds. Widely used in food, beverages, and pharmaceutical industries.',
      ...
      applications: ['Spice Blends', 'Tea & Beverages', 'Pharmaceuticals', 'Baking'],
